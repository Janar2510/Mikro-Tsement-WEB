...
export function Surfaces({ dict }: { dict: any }) {
  ...
  const images: Record<string, string> = {
    "surface-1": "/assets/surfaces/baxab.png",
    "surface-2": "/assets/surfaces/ecocemento.png",
    "surface-3": "/assets/surfaces/microcemento.png",
    "surface-4": "/assets/surfaces/tswim.png",
    "surface-5": "/assets/surfaces/summery.png",
    "surface-6": "/assets/surfaces/real-metals.png",
  };
            ...
            {dict.items.map((surface: any, idx: number) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 ease-out">
                  <div className="backdrop-blur-md bg-white/20 p-6 border border-white/30">
