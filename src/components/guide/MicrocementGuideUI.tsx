...
interface MicrocementGuideUIProps {
  dict: any;
  lang: string;
}
...
export function MicrocementGuideUI({ dict, lang }: MicrocementGuideUIProps) {
  const g = dict.guide_luxury_concrete;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-32">
          ...
          >
            <Image
              ...
              alt="Luxury Concrete® Minimalistic Interior"
              fill
